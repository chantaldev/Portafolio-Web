...
export const ShoppingCartProvider = ({children}) => {
  ...
  useEffect(() => {
    // Fecth: Hola soy home, ocupo tu info.
    fetch('https://fakestoreapi.com/products')
    // el fecth viene en promesa entonces hay que escribirla
  ...
  useEffect(() => {
    ...
    if(!searchByTitle && !searchByCategory) setFilteredItems(filterBy(null,items, searchByCategory))
